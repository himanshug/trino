...
{
    public static final String NAME = "native_query";

    private final BigQueryClientFactory clientFactory;

    @Inject
    public NativeQuery(BigQueryClientFactory clientFactory)
    {
    ...
    {
        return new RemoteQueryFunction(clientFactory);
    }
            ...
            extends ConnectorTableFunction
    {
        ...
        public RemoteQueryFunction(BigQueryClientFactory clientFactory)
        {
            super(
                    SCHEMA_NAME,
                    NAME,
        ...
        public TableFunctionAnalysis analyze(ConnectorSession session, ConnectorTransactionHandle transaction, Map<String, Argument> arguments)
        {
            ...
            NativeQueryHandle handle = new NativeQueryHandle(tableHandle.withProjectedColumns(columns.stream().map(c -> (ColumnHandle) c).collect(toList())));
    ...
    public static class NativeQueryHandle
            implements ConnectorTableFunctionHandle
    {
        private final BigQueryTableHandle tableHandle;

        @JsonCreator
        public NativeQueryHandle(@JsonProperty("tableHandle") BigQueryTableHandle tableHandle)
        {
