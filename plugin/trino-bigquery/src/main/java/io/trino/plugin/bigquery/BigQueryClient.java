...
public class BigQueryClient
{
    ...
    public Schema getSchema(String sql)
    {
        ...
        JobStatistics statistics = bigQuery.create(jobInfo).getStatistics();
        verify(statistics instanceof QueryStatistics);
        ...
        return requireNonNull(queryStatistics.getSchema(), "Result schema not provided for query");
    }
